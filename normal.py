...
while number < 1 or number > 9:
    number = int(input('Число не соответсвует требованиям. Введите число от 1 до 9: '))
print('Вы попали в интервал. Квардрат вашего числа: ' + str(number**2))
...
a, b = b, a     # меняем местами знач. переменных
print(a, b)
